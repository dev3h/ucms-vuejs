      ...
      <div class="mt-5">
        <div v-if="!twoFactorEnabled">
          <ConfirmsPassword @confirmed="enableTwoFactorAuthentication">
            <el-button type="primary" :class="{ 'opacity-25': enabling }" :disabled="enabling">{{
              $t('button.enable')
            }}</el-button>
          </ConfirmsPassword>
        </div>
        ...
        <div v-else>
          ...
          <ConfirmsPassword @confirmed="regenerateRecoveryCodes">
            <el-button v-if="recoveryCodes.length > 0 && !confirming">{{
              $t('button.re-recovery-code')
            }}</el-button>
          </ConfirmsPassword>

          <ConfirmsPassword @confirmed="showRecoveryCodes">
            <el-button v-if="recoveryCodes.length === 0 && !confirming" type="primary">{{
              $t('button.show-recovery-code')
            }}</el-button>
          </ConfirmsPassword>
